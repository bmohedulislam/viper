            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    ...
                    {{-- @forelse (App\Models\Wishlist::where('user_id',auth()->id())->get() as $wishlist)
                         <li>
                        <a href="single-product.html" class="image"><img src="{{ asset('uploads/product_photos') }}/{{ App\Models\Product::find($wishlist->product_id)->product_photo }}" alt="Cart product Image"></a>
                        <div class="content">
                            <a href="single-product.html" class="title">{{ App\Models\Product::find($wishlist->product_id)->product_name }}</a>
                            <span class="quantity-price">1 x <span class="amount">${{ App\Models\Product::find($wishlist->product_id)->product_price }}</span></span>
