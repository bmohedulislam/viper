                ...
                <div class="slimscroll-menu" id="remove-scroll">
                    ...
                    <div class="topbar-left">
                        <a href="index.html" class="logo">
                            <span>
                                <img src="{{ asset('dashbord') }}/assets/images/logo.png" alt="" height="22">
                            </span>
                            <i>
                                <img src="{{ asset('dashbord') }}/assets/images/logo_sm.png" alt="" height="28">
                            </i>
                        </a>
                    </div>
                    ...
                    <div class="user-box">
                        <div class="user-img">
                            <img src="{{ asset('uploads/profile_photos').'/'.Auth::user()->profile_photo??'none' }}" title="Mat Helme" class="rounded-circle img-fluid">
                        </div>
                        <h5><a href="">{{ Auth::user()->name??'none' }}</a> </h5>
                        <p class="text-muted">
                            @if (auth()->user()->role ==1)
                                customer
                        ...
                        <ul class="list-unstyled topbar-right-menu float-right mb-0">
                            ...
                            <li class="dropdown notification-list">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-animated dropdown-lg">
                                    ...
                                    <div class="slimscroll" style="max-height: 230px;">
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="{{ asset('dashbord') }}/assets/images/users/avatar-2.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="{{ asset('dashbord') }}/assets/images/users/avatar-3.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="{{ asset('dashbord') }}/assets/images/users/avatar-4.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="{{ asset('dashbord') }}/assets/images/users/avatar-5.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                                        ...
                                        <!-- item-->
                                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                                            <div class="notify-icon"><img src="{{ asset('dashbord') }}/assets/images/users/avatar-6.jpg" class="img-fluid rounded-circle" alt="" /> </div>
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user" data-toggle="dropdown" href="#" role="button"
                                   aria-haspopup="false" aria-expanded="false">
                                    <img src="{{ asset('uploads/profile_photos').'/'.Auth::user()->profile_photo??'none' }}" alt="user" class="rounded-circle">
                                    <span class="ml-1">{{ Auth::user()->name??'none' }}<i class="mdi mdi-chevron-down"></i> </span>
                                </a>
