                ...
                <div class="col-lg-6 col-sm-12 col-xs-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="product-details-content quickview-content">
                        ...
                        <div class="pro-details-categories-info pro-details-same-style d-flex">
                            ...
                            <ul class="d-flex">
                                <li>
                                    <a href="{{ route('categorywiseproducts',$single_product_info->category_id) }}">{{ $single_product_info->relationtocategory->category_name}}</a>
                                </li>
                            </ul>
                        </div>
                    ...
                    @forelse ( $related_products as  $product)
                        ...
                        <div class="product">
                            ...
                            <div class="content">
                                ...
                                <h5 class="title"><a href="{{ url('product/details') }}/{{ $product->product_slug }}">{{ $product->product_name }}">{{ $product->product_name }}
                                    </a>
                                </h5>
                                <span class="price">
