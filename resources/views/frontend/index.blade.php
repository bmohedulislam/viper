                        ...
                        <div class="nav-center">
                            <ul class="product-tab-nav nav align-items-center justify-content-center">
                               ...
                               @foreach ($categories as $category)
                                 <li class="nav-item"><a class="nav-link" data-bs-toggle="tab" href="#tab-product-{{ $category->category_name }}">{{ $category->category_name }}</a></li>
                               @endforeach
                            </ul>
                        </div>
                        <!-- Tab End -->
            ...
            <div class="col-12 col-lg-4">
                <div class="single-banner-2">
                    ...
                    <div class="item-disc">
                        ...
                        <a href="{{ route('categorywiseproducts',$category->id) }}" class="shop-link btn btn-primary">Shop Now <i class="fa fa-shopping-basket ml-5px" aria-hidden="true"></i></a>
                    </div>
                </div>
            </div>
            @endforeach
